...
public class Tuple extends HashMap<String, String> {
	...
	public Tuple(final HashSet<String> varSet, final HashSet<String> visibleVars, final Tuple tuple) {
		super();
	...
	public Tuple(final HashSet<String> varSet, final HashSet<String> visibleVars) {
