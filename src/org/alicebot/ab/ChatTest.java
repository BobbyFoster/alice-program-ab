...
public class ChatTest {
	...
	String pairs[][] = {
			...
			{
					"what word can you make from the initial letters of rocket, octopus, banana, owl and treacle",
					"R O B O T" },
			...
			{ "Have you been in a contest before?",
					"I have competed in the Loebner Prize and the Chatterbox Challenge." },
			...
			{ "My friend Chris likes to play football. What sports do you like to play?",
					"As a computer program, I am unable to play sports" },
			{ "Are you a human or a computer?", "I am a mobile virtual assistant robot." },
