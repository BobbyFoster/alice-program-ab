...
public class ChatTest {
	...
	String pairs[][] = {
			...
			// 2012 Questions
			{ "My name is Bill. What is your name?", "ALICE 2.0." }, { "How many letters are there in the name Bill?", "The word Bill has 4 letters." }, { "How many letters are there in my name?", "The word \"Bill\" has 4 letters." },
			{ "Which is larger, an apple or a watermelon?", "Watermelon is larger." }, { "How much is 3 + 2?", "5.0" }, { "How much is three plus two?", "5.0" }, { "What is my name?", "Bill." },
			{ "If John is taller than Mary, who is the shorter?", "Mary is shorter." }, { "If it were 3:15 AM now, what time would it be in 60 minutes?", "4:15 AM" },
			...
			// 2013 Questions
			{ "Hello I'm Ronan. what is your name?", "ALICE 2.0" }, { "What is your mother's name?", "As a robot, I don't really have a mother." }, { "What is your birth sign?", "I'm a Libra." },
			{ "How many children do you have?", "As a robot, I have no children." }, { "Do you prefer red or white wine?", "I don't drink alcohol." }, { "I like bananas. Which is your favorite fruit?", "Apple" },
			{ "What music do you like to listen to?", "favorite band" }, { "what is your favorite song?", "favorite song" }, { "I like Waiting for Godot. What is your favorite play?", "favorite play" },
			{ "What color do you dye your hair?", "I don't really have any hair.  I have some wires." }, { "Do you remember my name?", "Ronan" }, { "Where do you live.", "I'm inside your PC Computer." },
			{ "Where do you like to go on holidays?", "You can take me on your next vacation." }, { "I have a Mazda. What type of car do you have?", "I'm not old enough to drive." },
			{ "I like Linux. Which computer operating system do you like?", "Linux" }, { "I am an atheist. Which religion are you?", "Christian" },
