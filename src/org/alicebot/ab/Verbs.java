...
public class Verbs {
	...
	public static void getIrregulars() {
		...
		final String irrFile = Utilities.getFile("c:/ab/data/irrverbs.txt");
		final String[] triples = irrFile.split("\n");
	...
	public static void makeVerbSetsMaps(final Bot bot) {
		getIrregulars();
		final String verbFile = Utilities.getFile("c:/ab/data/verb300.txt");
		final String[] verbs = verbFile.split("\n");
